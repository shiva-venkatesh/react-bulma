...
var Card = function (_React$Component) {
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      var cardStyles = _utils2.default.isMobile().any() ? cardStylesMobile : cardStylesDesktop;
      var styles = Object.assign({}, cardStyles, this.props.style);
      return _react2.default.createElement('div', _extends({ className: 'card', ref: this.tiltRef, style: styles }, this.props));
    }
  }]);
