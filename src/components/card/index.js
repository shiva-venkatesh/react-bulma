...
class Card extends React.Component {
  ...
  render() {
    const cardStyles = Utils.isMobile().any() ? cardStylesMobile : cardStylesDesktop;
    const styles = Object.assign({}, cardStyles, this.props.style)
    return <div className="card" ref={this.tiltRef} style={styles} {...this.props} />
  }
}
